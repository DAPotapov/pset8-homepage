...
function validation(){
    ...
    // Lets control that user don't input anything besides numbers and spaces (spaces ok - they will be cleaned later)
    var pattern = /[^ 0-9]/;
    ...
    // If no garbage in string then proceed with determine of payment system and validation
        ...
        if (n > 1) {
            ...
            if (textnode.nodeValue != '')
            {
                ...
                cardname.setAttribute('id', 'banksystem');
